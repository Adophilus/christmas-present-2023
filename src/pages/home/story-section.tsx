...
import { StoryBackground, StoryContext } from './story-context';
...
const StorySection: FunctionComponent<{
  ...
  const { background, setStoryBackground } = useContext(StoryContext)
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <h2 className={twMerge("text-5xl font-bold tracking-widest font-Rubik", options.textColor)}>
                  {icon ? (
                    <h3 className="text-8xl mb-6 animate-bounce">
                      {icon}
                    </h3>
                  ) : null}
                  <h3 className={twMerge(options.fontFamily, options.fontSize)}>
                    {text}
                  </h3>
                </h2>
              </Transition.Child>
